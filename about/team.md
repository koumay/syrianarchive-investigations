...
Hadi has been working on collecting, verifying, investigating, and preserving visual documentation in order to expose and draw attention to human rights violations committed by all sides in the Syrian conflict, and to make sure that lawyers, NGOs, and journalists are able to use verified data for accountability, advocacy, as well as transitional justice purposes. Hadi has previously worked with Tactical Technology Collective for 5 years to support journalists and human rights defenders
in securing their data, devices and communications online. In addition to working with the Syrian Archive, Hadi is part-time open source investigator at the Human Rights Watch. He also contributes to
investigations with Bellingcat. Hadi is also a fellow at the Centre for Internet and Human Rights.
